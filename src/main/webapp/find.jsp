...
<%@include file="HeadPage.jsp"%>
	...
	<div class="updates-agile">
	     <div class="container">
		      <h3 class="tittle">找到新车</h3>
		<div class="inner_tabs">
		<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li role="presentation" class=""><a href="#updates1" id="updates-tab1" role="tab" data-toggle="tab" aria-controls="updates" aria-expanded="false">牌子</a></li>
						...
						<div id="myTabContent" class="tab-content">
							...
							<div class="news-updates car">
										...
										<ul class="cars-list">
										 <li>
											<a class="img-car" href="upcoming.jsp">
