...
public interface IComDAO {
	...
	public List<CommodityPO> findByPrice(int currPageNo, int number , double str);//大于定价查询
	public List<CommodityPO> findByColor(int currPageNo, int number , String str);//颜色查询
	public List<CommodityPO> findByAddress(int currPageNo, int number , String str);//所在地查询
